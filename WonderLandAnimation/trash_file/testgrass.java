...
public class testgrass extends JPanel {
    double px = 0;
    int x = 1;
    ...
    public void paintComponent(Graphics g) {
        ...
        //Draw over the original image
        g2.setColor(new Color(85, 48, 101));
        bezierPaint(g2, 0, 499, 16, 514, 55, 493, 95, 504, 5);
        bezierPaint(g2, 95, 504, 134, 494, 151, 495, 199, 510, 5);
        bezierPaint(g2, 199, 510, 238, 509, 300, 490, 361, 494, 5);
